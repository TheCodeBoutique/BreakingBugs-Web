Breakingbugs.navigationItemsController = Alto.ArrayController.create ({
    ...
    content: [
        ...
        Alto.Object.create({title: Alto.String.loc('NEW_BUG_NAVIGATION_TITLE'), route: '#/file-bug'}),
        Alto.Object.create({title: Alto.String.loc('FEATURE_REQUEST_NAVIGATION_TITLE'), route: '#/feature-request'}),
